...
|                            |❌     | The code fully satisfies the style standards the team set up.                                                                                                                   | There are checkstyle errors. Please fix them asap. |
...
### Other comments
If your team wants, you can complete all the missing weekly reports asap and I'd be happy to give an exception for the violation of the grading rubric item.
